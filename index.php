...
if (isset($_GET['steamid'])) {
    $data = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=667D6FD051AFB85AD996AA5C7723F02C&steamids='.$_GET['steamid'];
...
body {
  ...
  font-size: 1.75em;
  font-weight: 200;
  background: url(https://i.imgur.com/xp7AXld.jpg) center no-repeat;
...
<body>
  ...
  <div id="left">
    <div id="welcome">
      <div id="player-avatar-module">
        <img id="player-avatar" src=<?php echo $avatar?> </img>
      </div>
      Welcome
    </div>
    <div class="module" id="nickname-module">
      ...
      <span id="name"><?php echo $plname ?></span>
    </div>
    <div class="module" id="id-module">
      <div id="key-icon" class="icon"></div>
      <span id="steamid"> <?php echo $_GET['steamid'] ?> </span>
    </div>
  ...
  <div id="right">
    ...
    <div class="module" id="map-module">
      ...
      <span id="map">getting map info.</span>
    </div>
    <div class="module" id="download-module">
      <div id="download-icon" class="icon"></div>
      <span id="downloading">Getting information...</span>
...
var hey = 0;
function SetFilesTotal( total ) {hey=total;};
...
function DownloadingFile( fileName ) {document.getElementById("downloading").innerHTML = fileName;};

function SetStatusChanged( status ) {document.getElementById("downloading").innerHTML = status};
</script>  
